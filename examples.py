...
from algorithms.bayesian_opt import BayesianOpt, UCB, DynamicUCB, ExpectedImprovement, ProbOfImprovement, EpsGreedy, YananStrategy
...
def eg_bayesian_opt():
	...
	for i in range(20):
		...
		plt.scatter(x[0], truef(x[0]), c='b', label='Proposed Evaluation')
		plt.show()
